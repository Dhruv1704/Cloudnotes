...
export default function NoteCard(props) {
    ...
    return (
        <>
            <div
                className={`bg-[${note.color}] w-[348px] h-[320px] break-words whitespace-break-spaces rounded-3xl p-7 px-8 shadow-lg hover:scale-105 duration-300 ease-out cursor-pointer flex flex-col justify-between`}>
